...
exports.setBaseGraphqlMocks = function (mocks) {
    if (!commonMocks) {
        ...
        throw new Error("setBaseGraphqlMocks may only be called once, already called.");
    }
    return mocks;
};
/**
...
exports.setBaseOperationOptions = function (options) {
    if (!commonOptions) {
        ...
        throw new Error("setBaseOperationOptions may only be called once, already called.");
    }
    return options;
};
/**
...
Cypress.Commands.add("mockGraphql", function (options) {
    var mergedOptions = tslib_1.__assign({}, (commonOptions || {}), (options || {}));
    var _a = mergedOptions.endpoint, endpoint = _a === void 0 ? "/graphql" : _a, _b = mergedOptions.delay, delay = _b === void 0 ? 0 : _b, _c = mergedOptions.operations, operations = _c === void 0 ? {} : _c, _d = mergedOptions.mocks, mocks = _d === void 0 ? {} : _d, _e = mergedOptions.schema, schema = _e === void 0 ? undefined : _e;
    if (!schema) {
        throw new Error("Schema must be provided to the mockGraphql or setBaseOperationOptions");
    }
    ...
    graphql_tools_1.addMockFunctionsToSchema({
        ...
        mocks: tslib_1.__assign({}, commonMocks, mocks)
    });
    ...
    cy.wrap({
        setOperations: function (options) {
            ...
            currentOps = tslib_1.__assign({}, currentOps, options.operations);
        }
